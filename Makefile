...
install: all
	...
	@mkdir -p $(DESTDIR)/$(PREFIX)/include/confslice
	install src/*.h $(DESTDIR)/$(PREFIX)/include/confslice/.

#
# Removing
#
remove:
	rm -rf $(DESTDIR)/$(PREFIX)/lib/libconfslice.*
	rm -rf $(DESTDIR)/$(PREFIX)/include/confslice*
